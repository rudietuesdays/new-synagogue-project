		...
		<div class="ad-row clearfix">
			...
			<div id="getting-started" class="bg">
				...
				<div class="ad-row clearfix">
						...
						<div class="section options">
							<h4>
								<?php esc_html_e('Theme Update Logs', 'maisha'); ?>
							</h4>
							<p class="about">
								<?php printf(esc_html__('View the full change log for our themes.', 'maisha'), $theme_data->Name); ?>
							</p>
							<p>
						...
						<div class="section recommend clear">
							...
							?>
							<!-- WPForms -->
							<p><strong><?php esc_html_e( 'WPForms Lite', 'maisha' ); ?></strong></p>
							<p><?php esc_html_e( 'Contact Form by WPForms. Drag & Drop Form Builder for WordPress', 'maisha' ); ?></p>
							...
							<p><a href="<?php echo esc_url( wp_nonce_url( self_admin_url( 'update.php?action=install-plugin&plugin=wpforms-lite' ), 'install-plugin_wpforms-lite' ) ); ?>" class="button button-primary"><?php esc_html_e( 'WPForms Lite', 'maisha' ); ?></a></p>
