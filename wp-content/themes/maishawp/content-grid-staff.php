...
<div class="staff-column clearfix">
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<?php if ( has_post_thumbnail() ) { ?>
			<?php if(get_theme_mod( 'maisha_image_link_staff' )) : ?>
				<?php the_post_thumbnail( 'maisha-staff-child-page-thumbnail' ); ?>
			<?php else: ?>
		...
		<div class="entry-content">
			<?php if(get_theme_mod( 'maisha_child_title_link_staff' )) : ?>
