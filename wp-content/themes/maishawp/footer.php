			...
			<div class="site-info">
				<div class="hfeed site">
					<div class="content site-content">
						...
						<?php if('custom-link' === get_theme_mod( 'maisha_copyright_link' )) : ?>
							<a href="<?php echo wp_kses_post( get_theme_mod( 'maisha_copyright_custom_link' ) ); ?>" title="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>"> <?php echo esc_textarea ( get_theme_mod( 'maisha_copyright', 'Maisha Theme by Anariel Design.' ) ); ?> </a>
						<?php else: ?>
