 ...
 */
function maisha_gutenberg_styles() {

	// Load the theme styles within Gutenberg.
	wp_enqueue_style( 'maisha-gutenberg', get_theme_file_uri( '/editor.css' ), false, '1.1.2', 'all' );

	// Add custom fonts to Gutenberg.
	wp_enqueue_style( 'maisha-fonts', maisha_fonts_url(), array(), null );
}
add_action( 'enqueue_block_editor_assets', 'maisha_gutenberg_styles' );
...
/**
  ...
  * @return int
  */
function maisha_loop_shop_per_page() {
	return -1; //return any number, -1 === show all
};
add_filter('loop_shop_per_page', 'maisha_loop_shop_per_page', 40, 0);
