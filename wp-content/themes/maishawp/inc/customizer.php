...
*/
	...
	$wp_customize->add_setting( 'maisha_mobile_menu_layout', array(
		'default'           => 'default-mobile-menu',
		'sanitize_callback' => 'maisha_sanitize_choices',
	) );
	$wp_customize->add_control( 'maisha_mobile_menu_layout', array(
		'label'             => esc_html__( 'Mobile Menu Options', 'maisha' ),
		'section'           => 'maisha_theme_options_header',
		'settings'          => 'maisha_mobile_menu_layout',
		'priority'          => 2,
		'type'              => 'radio',
		'choices'           => array(
			'fixed-mobile-menu'   => esc_html__( 'Sticky Menu', 'maisha' ),
			'default-mobile-menu'   => esc_html__( 'Default Menu', 'maisha' ),
		)
	) );
...
*/
	...
	*/
	...
	/* Child Pages Image Link */
	$wp_customize->add_setting( 'maisha_image_link_about', array(
		'default'           => false,
		'sanitize_callback' => 'maisha_sanitize_checkbox',
	) );

	$wp_customize->add_control( 'maisha_image_link_about', array(
		'label'             => esc_html__( 'Activate Featured Image Link', 'maisha' ),
		'section'           => 'maisha_theme_options_about',
		'priority'          => 3,
		'type'              => 'checkbox',
	) );
	...
	/* Child Pages Title Link */
	$wp_customize->add_setting( 'maisha_child_title_link_about', array(
		'default'           => false,
		'sanitize_callback' => 'maisha_sanitize_checkbox',
	) );

	$wp_customize->add_control( 'maisha_child_title_link_about', array(
		'label'             => esc_html__( 'Activate Title Link', 'maisha' ),
		'section'           => 'maisha_theme_options_about',
		'priority'          => 4,
		'type'              => 'checkbox',
	) );
...
*/
	...
	/* Child Pages Image Link */
	$wp_customize->add_setting( 'maisha_image_link_projects', array(
		'default'           => false,
		'sanitize_callback' => 'maisha_sanitize_checkbox',
	) );

	$wp_customize->add_control( 'maisha_image_link_projects', array(
		'label'             => esc_html__( 'Deactivate Featured Image Link', 'maisha' ),
		'section'           => 'maisha_theme_options_projects',
		'priority'          => 3,
		'type'              => 'checkbox',
	) );
	...
	/* Child Pages Title Link */
	$wp_customize->add_setting( 'maisha_child_title_link_projects', array(
		'default'           => false,
		'sanitize_callback' => 'maisha_sanitize_checkbox',
	) );

	$wp_customize->add_control( 'maisha_child_title_link_projects', array(
		'label'             => esc_html__( 'Deactivate Title Link', 'maisha' ),
		'section'           => 'maisha_theme_options_projects',
		'priority'          => 4,
		'type'              => 'checkbox',
	) );
...
*/
	...
	/* Child Pages Image Link */
	$wp_customize->add_setting( 'maisha_image_link_causes', array(
		'default'           => false,
		'sanitize_callback' => 'maisha_sanitize_checkbox',
	) );

	$wp_customize->add_control( 'maisha_image_link_causes', array(
		'label'             => esc_html__( 'Deactivate Featured Image Link', 'maisha' ),
		'section'           => 'maisha_theme_options_causes',
		'priority'          => 3,
		'type'              => 'checkbox',
	...
	/* Child Pages Title Link */
	$wp_customize->add_setting( 'maisha_child_title_link_causes', array(
		'default'           => false,
		'sanitize_callback' => 'maisha_sanitize_checkbox',
	) );

	$wp_customize->add_control( 'maisha_child_title_link_causes', array(
		'label'             => esc_html__( 'Deactivate Title Link', 'maisha' ),
		'section'           => 'maisha_theme_options_causes',
		'priority'          => 4,
		'type'              => 'checkbox',
...
*/
	...
	/* Child Pages Image Link */
	$wp_customize->add_setting( 'maisha_image_link_stories', array(
		'default'           => false,
		'sanitize_callback' => 'maisha_sanitize_checkbox',
	) );

	$wp_customize->add_control( 'maisha_image_link_stories', array(
		'label'             => esc_html__( 'Deactivate Featured Image Link', 'maisha' ),
		'section'           => 'maisha_theme_options_stories',
		'priority'          => 3,
		'type'              => 'checkbox',
	...
	/* Child Pages Title Link */
	$wp_customize->add_setting( 'maisha_child_title_link_stories', array(
		'default'           => false,
		'sanitize_callback' => 'maisha_sanitize_checkbox',
	) );

	$wp_customize->add_control( 'maisha_child_title_link_stories', array(
		'label'             => esc_html__( 'Deactivate Title Link', 'maisha' ),
		'section'           => 'maisha_theme_options_stories',
		'priority'          => 4,
		'type'              => 'checkbox',
...
*/
	...
	/* Child Pages Image Link */
	$wp_customize->add_setting( 'maisha_image_link_staff', array(
		'default'           => false,
		'sanitize_callback' => 'maisha_sanitize_checkbox',
	) );

	$wp_customize->add_control( 'maisha_image_link_staff', array(
		'label'             => esc_html__( 'Deactivate Featured Image Link', 'maisha' ),
		'section'           => 'maisha_theme_options_staff',
		'priority'          => 3,
		'type'              => 'checkbox',
	...
	/* Child Pages Title Link */
	$wp_customize->add_setting( 'maisha_child_title_link_staff', array(
		'default'           => false,
		'sanitize_callback' => 'maisha_sanitize_checkbox',
	) );

	$wp_customize->add_control( 'maisha_child_title_link_staff', array(
		'label'             => esc_html__( 'Deactivate Title Link', 'maisha' ),
		'section'           => 'maisha_theme_options_staff',
		'priority'          => 4,
		'type'              => 'checkbox',
...
*/
	...
	$wp_customize->add_control( 'maisha_copyright', array(
		...
		$wp_customize->add_setting( 'maisha_copyright_link', array(
		'default'           => 'default-link',
		'sanitize_callback' => 'maisha_sanitize_choices',
	) );
	$wp_customize->add_control( 'maisha_copyright_link', array(
		'label'             => esc_html__( 'Copyright Link', 'maisha' ),
		'section'           => 'maisha_copyright_section',
		'settings'          => 'maisha_copyright_link',
		'priority'          => 3,
		'type'              => 'radio',
		'choices'           => array(
			'default-link'   => esc_html__( 'Default (Homepage)', 'maisha' ),
			'custom-link'  => esc_html__( 'Custom URL', 'maisha' ),
		)
	) );
	
	/* Copyright Custom Link */
	$wp_customize->add_setting( 'maisha_copyright_custom_link', array(
		'default'           => '',
		'sanitize_callback' => 'wp_kses_post',
	) );
	$wp_customize->add_control( 'maisha_copyright_custom_link', array(
		'section'           => 'maisha_copyright_section',
		'priority'          => 4,
		'type'              => 'text',
	) );
