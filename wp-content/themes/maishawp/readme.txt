...
1.7.8 - October 22, 2019

- support for the new WooCommerce gallery

1.7.7 - April 22, 2019

- added more Copyright options inside the Customizer - add your custom copyright link instead of linking to the homepage

1.7.6 - February 17, 2019

- fix for the WooCommerce page in case you have a right sidebar active

1.7.5 - January 7, 2019

- fix for the blog featured image link and title margin

1.7.4 - November 19, 2018

- fix in the functions.php file for the WooCommerce create_function that is deprecated from PHP 7.2 

1.7.3 - October 29, 2018

- improved support for the new WordPress editor
- added more options for the About, Projects, Causes, Stories and Staff page in the Customizer - activate link for the child page featured image and title
- added option for the sticky menu on mobile

1.7.2 - September 12, 2018

- improved support for the new WordPress editor
- few fixes inside the style.css - in case there are no widgets inside the blog sidebar

1.7.1 - August 12, 2018
...
1.6.8 - April 9, 2018
- small fix in the archive.php file

1.6.7 - February 19, 2018
- better menu accessibility

1.6.6 - February 8, 2018
- added new option inside the Customizer > Theme Options - Give Donations Page Options
- small fix for the one-click demo file

1.6.5 - January 23, 2018

- small fixes for the grid
- added one-click demo files to the theme

1.6.4 - January 17, 2018

- accessibility improvements - link and button hover improved 

1.6.3 - January 8, 2018

- small fixes inside the style.css for the Basic Page Template
- added basic Gutenberg support

1.6.2 - December 13, 2017

-  added new functionality for the Extra Page template

 1.6.1 - November 27, 2017

- small fix for the Theme Options > Front Page > First Content Block - number of columns for child pages 

1.6.0 - November 17, 2017

- small fix for the one-click demo import
